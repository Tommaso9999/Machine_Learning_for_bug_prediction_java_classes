...
folder_name = r"results_of_classifiers_against_biased_classifier_best_params"
...
def evaluate(csv):
    ...
    plt.tight_layout()  
    plt.savefig(r'results_of_classifiers_against_biased_classifier_best_params/classifier_results.png')  
    plt.show()

    result_df.to_csv(r'results_of_classifiers_against_biased_classifier_best_params/classifiers_vs_biased_classifier_results.csv')  



if __name__ == "__main__":
    csv = r'models_train_results_best_configuration/results.csv'
    evaluate(csv)
